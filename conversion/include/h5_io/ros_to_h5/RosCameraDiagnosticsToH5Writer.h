#ifndef ROSCAMERADIAGNOSTICSTOH5WRITER_H
#define ROSCAMERADIAGNOSTICSTOH5WRITER_H
...
class RosCameraDiagnosticsToH5Writer : public RosMessageToH5Writer
{
public:
    RosCameraDiagnosticsToH5Writer(
...
#endif //ROSCAMERADIAGNOSTICSTOH5WRITER_H